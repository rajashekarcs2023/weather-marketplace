...
async def get_weather_analysis(location):
    ...
    prompt = f"What's the weather like in {location}? Give a brief, natural response with two recommendations."
...
def init_agent():
    ...
    try:
        ...
        logger.info("Premium Weather agent initialized successfully!")
