...
def webhook():
    try:
        ...
        response_payload = {
            ...
            "price": 0.99  # Including price in response
        }
...
def init_app():
    ...
    try:
        ...
        register_with_agentverse(
            ...
            url="http://localhost:5009/webhook",  # Change port for each agent
...
if __name__ == "__main__":
    load_dotenv()
    init_app()
    app.run(host="0.0.0.0", port=5009)  # Change port for each agent